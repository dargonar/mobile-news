...
from utils import FrontendHandler, HtmlBuilderMixing, get_or_404, read_clean, date2iso, build_xml_string
...
class ScreenController(FrontendHandler, HtmlBuilderMixing):  
  ...
  def get_screen(self, **kwargs):  
    ...
    if url.startswith('noticia://') and size == 'big':
      ...
      logging.exception(u' ------- section: [%s]' % section)
