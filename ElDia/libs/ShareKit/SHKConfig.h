...
#define SHKMyAppName			@"El Dia"
#define SHKMyAppURL				@"http://www.eldia.com.ar"
...
// appid 200298223439703
// appsecret 400da4aa7d76b52a29d80ab39f2f458f
#define SHKFacebookUseSessionProxy  NO 
#define SHKFacebookKey				@"200298223439703"
#define SHKFacebookSecret			@"400da4aa7d76b52a29d80ab39f2f458f"
 ...
 */
#define SHKTwitterConsumerKey		@"jkPcehgUmSBdRBvOvz9aQ"
#define SHKTwitterSecret			@"4woY6QydnCcmKBsQNooNgQyN1aAi7aBXTBvoMnKexA"
#define SHKTwitterCallbackUrl		@"" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"@eldialp" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
